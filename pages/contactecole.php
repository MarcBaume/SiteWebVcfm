...
<head>
    ...
    <title>École de cyclisme - VCFM Vélo-Club Franches-Montagnes</title>
	<meta name="viewport" content="width=device-width">
    <meta name="description" content="École de cyclisme du VCFM, formulaire de contact  -  ">
...
<body>
    ...
    <main>
	   <h1>École de cyclisme du VCFM</h1>	
        <?php
            // Spam check
            //session_start();
            ...
            echo '<form action="contactecole.php" method="post">';
            ...
            //mail
            if ($mail == true){
                $empfaenger = "marcdubois85@gmail.com, activites@vcfm.ch";
//                $empfaenger = "activites@vcfm.ch";
                $absender   = "info@vcfm.ch";
                $betreff    = "Formulaire de contact - l'école de cyclisme";
